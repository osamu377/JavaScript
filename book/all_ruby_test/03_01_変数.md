...
また、**「<ruby>再代入<rt>さいだいにゅう</rt></ruby>」** とは、「<ruby>一度<rt>いちど</rt></ruby>、<ruby>変数<rt>へんすう</rt></ruby>に<ruby>値<rt>あたい</rt></ruby>を<ruby>代入<rt>だいにゅう</rt></ruby>したあとで、<ruby>別<rt>べつ</rt></ruby>の<ruby>値<rt>あたい</rt></ruby>を<ruby>入<rt>い</rt></ruby>れなおす」ことです。
...
|---|---|---|---|
|let|<ruby>中身<rt>なかみ</rt></ruby>を<ruby>入<rt>い</rt></ruby>れ<ruby>替<rt>かえ</rt></ruby>られる<ruby>箱<rt>はこ</rt><ruby>|ゲームのスコアやクリックされた<ruby>回数<rt>かいすう</rt></ruby>など、<ruby>後<rt>あと</rt></ruby>で<ruby>値<rt>あたい</rt></ruby>が<ruby>変<rt>か</rt></ruby>わるもの|`const MAX_LEVEL = 99;`|
|const|<ruby>一度<rt>いちど</rt><ruby><ruby>入<rt>い</rt></ruby>れたら<ruby>変<rt>か</rt></ruby>えられない<ruby>箱<rt>はこ</rt></ruby>|<ruby>名前<rt>なまえ</rt></ruby>、<ruby>誕生日<rt>たんじょうび</rt></ruby>、<ruby>設定値<rt>せっていち</rt></ruby>など、ずっと<ruby>同<rt>おな</rt></ruby>じもの|`let score = 0;` （あとで `score = 10;` と<ruby>変<rt>か</rt></ruby>えられる）|
...
* **<ruby>宣言<rt>せんげん</rt></ruby>と<ruby>初期化<rt>しょきか</rt></ruby>を<ruby>同時<rt>どうじ</rt></ruby>に<ruby>行<rt>おこな</rt></ruby>う<ruby>例<rt>れい</rt></ruby>**:
  ...
  ```javascript
  let myDog = "Rover"; // 宣言（せんげん）と同時(どうじ)に "Rover" という文字列(もじれつ)を入れる
  const pi = 3.14;     // constは宣言（せんげん）するときに必(かなら)ず初期化（しょきか）が必要(ひつよう)
...
* **<ruby>宣言<rt>せんげん</rt></ruby>だけ<ruby>先<rt>さき</rt></ruby>に<ruby>行<rt>おこな</rt></ruby>う<ruby>例<rt>れい</rt></ruby>（`let`のみ<ruby>可能<rt>かのう</rt></ruby>）**:
  ...
  ```javascript
  let myName; // 箱(はこ)だけ用意(ようい)する。このときの中身(なかみ)は undefined（未定義（みていぎ））となる
  myName = "Chris"; // あとから値(あたい)を代入（だいにゅう）する
...
ウェブページで「こんにちは」というメッセージを<ruby>表示<rt>ひょうじ</rt></ruby>したり、ユーザーの<ruby>名前<rt>なまえ</rt></ruby>を<ruby>扱<rt>あつか</rt></ruby>ったりする<ruby>際<rt>さい</rt></ruby>に<ruby>使<rt>つか</rt></ruby>われるのが「<ruby>文字列<rt>もじれつ</rt></ruby>」です。
...
* `+`（<ruby>足<rt>た</rt></ruby>し<ruby>算<rt>ざん</rt></ruby>）
* `-`（<ruby>引<rt>ひ</rt></ruby>き<ruby>算<rt>ざん</rt></ruby>）
* `*`（<ruby>掛<rt>か</rt></ruby>け<ruby>算<rt>ざん</rt></ruby>）
* `/`（<ruby>割<rt>わ</rt></ruby>り<ruby>算<rt>ざん</rt></ruby>）
* `%`（<ruby>余<rt>あま</rt></ruby>り）
...
| !    | 〜ではない (NOT) | true と false を<ruby>逆転<rt>ぎゃくてん</rt></ruby>させる  |

※ <ruby>比較演算子<rt>ひかくえんざんし</rt></ruby>と<ruby>論理演算子<rt>ろんりえんざんし</rt></ruby>については、<ruby>次<rt>つぎ</rt></ruby>の<ruby>章<rt>しょう</rt></ruby>で、もっと<ruby>詳<rt>くわ</rt></ruby>しく<ruby>説明<rt>せつめい</rt></ruby>します
